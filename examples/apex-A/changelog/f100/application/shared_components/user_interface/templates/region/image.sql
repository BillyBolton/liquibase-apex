...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(526258117937780813)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712371966399762318)
,p_plug_template_id=>wwv_flow_imp.id(526258117937780813)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712372484503762319)
,p_plug_template_id=>wwv_flow_imp.id(526258117937780813)
,p_name=>'Sub Regions'
