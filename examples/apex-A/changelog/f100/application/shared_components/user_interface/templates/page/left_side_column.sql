...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(1704158058940062455)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712191707799762163)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712192145020762164)
,p_page_template_id=>wwv_flow_imp.id(1704158058940062455)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712192637289762164)
,p_page_template_id=>wwv_flow_imp.id(1704158058940062455)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712193162141762164)
,p_page_template_id=>wwv_flow_imp.id(1704158058940062455)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712193711322762165)
,p_page_template_id=>wwv_flow_imp.id(1704158058940062455)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712194137718762165)
,p_page_template_id=>wwv_flow_imp.id(1704158058940062455)
,p_name=>'Left Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712194663597762165)
,p_page_template_id=>wwv_flow_imp.id(1704158058940062455)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712195172249762166)
,p_page_template_id=>wwv_flow_imp.id(1704158058940062455)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712195641048762166)
,p_page_template_id=>wwv_flow_imp.id(1704158058940062455)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712196210139762167)
,p_page_template_id=>wwv_flow_imp.id(1704158058940062455)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712196703215762167)
,p_page_template_id=>wwv_flow_imp.id(1704158058940062455)
