...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(1704170401755062525)
,p_theme_id=>42
,p_name=>'Modal Dialog'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712237640275762200)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712238194822762201)
,p_page_template_id=>wwv_flow_imp.id(1704170401755062525)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712238636660762201)
,p_page_template_id=>wwv_flow_imp.id(1704170401755062525)
