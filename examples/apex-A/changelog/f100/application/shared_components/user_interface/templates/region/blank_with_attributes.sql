...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1704182883380062578)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712277957163762236)
,p_plug_template_id=>wwv_flow_imp.id(1704182883380062578)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712278435412762236)
,p_plug_template_id=>wwv_flow_imp.id(1704182883380062578)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712278945749762236)
,p_plug_template_id=>wwv_flow_imp.id(1704182883380062578)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712279460345762237)
,p_plug_template_id=>wwv_flow_imp.id(1704182883380062578)
,p_name=>'Sub Regions'
