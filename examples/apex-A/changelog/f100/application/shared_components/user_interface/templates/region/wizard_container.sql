...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1704196714259062598)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712496363420762424)
,p_plug_template_id=>wwv_flow_imp.id(1704196714259062598)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712496857150762424)
,p_plug_template_id=>wwv_flow_imp.id(1704196714259062598)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712497323579762425)
,p_plug_template_id=>wwv_flow_imp.id(1704196714259062598)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712497844314762425)
,p_plug_template_id=>wwv_flow_imp.id(1704196714259062598)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712498387275762425)
,p_plug_template_id=>wwv_flow_imp.id(1704196714259062598)
