...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(1704175616433062534)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712244470725762207)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712245007795762207)
,p_page_template_id=>wwv_flow_imp.id(1704175616433062534)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712245479592762207)
,p_page_template_id=>wwv_flow_imp.id(1704175616433062534)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712245932760762208)
,p_page_template_id=>wwv_flow_imp.id(1704175616433062534)
,p_name=>'Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712246441163762208)
,p_page_template_id=>wwv_flow_imp.id(1704175616433062534)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712246987663762208)
,p_page_template_id=>wwv_flow_imp.id(1704175616433062534)
,p_name=>'Right Column'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712247474160762209)
,p_page_template_id=>wwv_flow_imp.id(1704175616433062534)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712247985944762209)
,p_page_template_id=>wwv_flow_imp.id(1704175616433062534)
,p_name=>'Footer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712248419757762209)
,p_page_template_id=>wwv_flow_imp.id(1704175616433062534)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712248947288762210)
,p_page_template_id=>wwv_flow_imp.id(1704175616433062534)
,p_name=>'Banner'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712249490515762210)
,p_page_template_id=>wwv_flow_imp.id(1704175616433062534)
