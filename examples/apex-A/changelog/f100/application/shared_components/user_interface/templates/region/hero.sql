...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1704188929759062585)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712364454760762312)
,p_plug_template_id=>wwv_flow_imp.id(1704188929759062585)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712364963144762312)
,p_plug_template_id=>wwv_flow_imp.id(1704188929759062585)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712365444406762313)
,p_plug_template_id=>wwv_flow_imp.id(1704188929759062585)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712365927416762313)
,p_plug_template_id=>wwv_flow_imp.id(1704188929759062585)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712366439209762313)
,p_plug_template_id=>wwv_flow_imp.id(1704188929759062585)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
