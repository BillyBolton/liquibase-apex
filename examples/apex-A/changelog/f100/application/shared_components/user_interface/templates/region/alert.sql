...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1704181037161062553)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712266183813762224)
,p_plug_template_id=>wwv_flow_imp.id(1704181037161062553)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712266683423762225)
,p_plug_template_id=>wwv_flow_imp.id(1704181037161062553)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712267214011762225)
,p_plug_template_id=>wwv_flow_imp.id(1704181037161062553)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712267676060762225)
,p_plug_template_id=>wwv_flow_imp.id(1704181037161062553)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712268178225762226)
,p_plug_template_id=>wwv_flow_imp.id(1704181037161062553)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712268695237762226)
,p_plug_template_id=>wwv_flow_imp.id(1704181037161062553)
,p_name=>'Sub Regions'
