...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1704191962619062589)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712424099323762362)
,p_plug_template_id=>wwv_flow_imp.id(1704191962619062589)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712424556237762363)
,p_plug_template_id=>wwv_flow_imp.id(1704191962619062589)
,p_name=>'Next'
,p_placeholder=>'NEXT'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712425050636762363)
,p_plug_template_id=>wwv_flow_imp.id(1704191962619062589)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712425593962762363)
,p_plug_template_id=>wwv_flow_imp.id(1704191962619062589)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712426100627762364)
,p_plug_template_id=>wwv_flow_imp.id(1704191962619062589)
,p_name=>'Sub Regions'
