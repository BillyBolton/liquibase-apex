...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(1704179927867062551)
,p_theme_id=>42
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712261319394762220)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712261871493762220)
,p_page_template_id=>wwv_flow_imp.id(1704179927867062551)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712262330177762220)
,p_page_template_id=>wwv_flow_imp.id(1704179927867062551)
