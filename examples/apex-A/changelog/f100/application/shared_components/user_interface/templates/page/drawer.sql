...
wwv_flow_imp_shared.create_template(
 p_id=>wwv_flow_imp.id(282792515465716496)
,p_theme_id=>42
,p_name=>'Drawer'
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712181549965762154)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712182061416762154)
,p_page_template_id=>wwv_flow_imp.id(282792515465716496)
...
wwv_flow_imp_shared.create_page_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712182566115762155)
,p_page_template_id=>wwv_flow_imp.id(282792515465716496)
