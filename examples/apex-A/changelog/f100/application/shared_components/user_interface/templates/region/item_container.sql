...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(416780350137628568)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712428637205762367)
,p_plug_template_id=>wwv_flow_imp.id(416780350137628568)
,p_name=>'Item'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712429128931762367)
,p_plug_template_id=>wwv_flow_imp.id(416780350137628568)
,p_name=>'Button End'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712429642427762367)
,p_plug_template_id=>wwv_flow_imp.id(416780350137628568)
,p_name=>'Button Start'
