...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1704189390368062586)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712328712960762281)
,p_plug_template_id=>wwv_flow_imp.id(1704189390368062586)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712329152994762281)
,p_plug_template_id=>wwv_flow_imp.id(1704189390368062586)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712329633348762281)
,p_plug_template_id=>wwv_flow_imp.id(1704189390368062586)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712330207970762282)
,p_plug_template_id=>wwv_flow_imp.id(1704189390368062586)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712330679645762282)
,p_plug_template_id=>wwv_flow_imp.id(1704189390368062586)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712331198454762283)
,p_plug_template_id=>wwv_flow_imp.id(1704189390368062586)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712331638607762283)
,p_plug_template_id=>wwv_flow_imp.id(1704189390368062586)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712332145755762283)
,p_plug_template_id=>wwv_flow_imp.id(1704189390368062586)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712332664326762283)
,p_plug_template_id=>wwv_flow_imp.id(1704189390368062586)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712333153819762284)
,p_plug_template_id=>wwv_flow_imp.id(1704189390368062586)
,p_name=>'Sub Regions'
