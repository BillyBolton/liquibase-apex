...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(282988885870716244)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712398948658762342)
,p_plug_template_id=>wwv_flow_imp.id(282988885870716244)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712399467421762342)
,p_plug_template_id=>wwv_flow_imp.id(282988885870716244)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712399950817762343)
,p_plug_template_id=>wwv_flow_imp.id(282988885870716244)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712400485027762343)
,p_plug_template_id=>wwv_flow_imp.id(282988885870716244)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712401002501762343)
,p_plug_template_id=>wwv_flow_imp.id(282988885870716244)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712401423161762344)
,p_plug_template_id=>wwv_flow_imp.id(282988885870716244)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712401977846762344)
,p_plug_template_id=>wwv_flow_imp.id(282988885870716244)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712402482554762344)
,p_plug_template_id=>wwv_flow_imp.id(282988885870716244)
,p_name=>'Sub Regions'
