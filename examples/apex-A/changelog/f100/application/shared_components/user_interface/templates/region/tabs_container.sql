...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1863627549577424154)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712475342051762407)
,p_plug_template_id=>wwv_flow_imp.id(1863627549577424154)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712475853880762407)
,p_plug_template_id=>wwv_flow_imp.id(1863627549577424154)
,p_name=>'Tabs'
