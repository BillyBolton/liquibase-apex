...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1942130453275928633)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712281879459762239)
,p_plug_template_id=>wwv_flow_imp.id(1942130453275928633)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712282333696762239)
,p_plug_template_id=>wwv_flow_imp.id(1942130453275928633)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712282851711762240)
,p_plug_template_id=>wwv_flow_imp.id(1942130453275928633)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712283414316762240)
,p_plug_template_id=>wwv_flow_imp.id(1942130453275928633)
,p_name=>'Sub Regions'
