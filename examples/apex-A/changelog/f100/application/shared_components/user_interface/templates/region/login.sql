...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1704192269974062590)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712435418455762372)
,p_plug_template_id=>wwv_flow_imp.id(1704192269974062590)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712435992712762373)
,p_plug_template_id=>wwv_flow_imp.id(1704192269974062590)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712436497801762373)
,p_plug_template_id=>wwv_flow_imp.id(1704192269974062590)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712437004845762373)
,p_plug_template_id=>wwv_flow_imp.id(1704192269974062590)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712437419595762374)
,p_plug_template_id=>wwv_flow_imp.id(1704192269974062590)
,p_name=>'Sub Regions'
