...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1127654121951791511)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712353751417762303)
,p_plug_template_id=>wwv_flow_imp.id(1127654121951791511)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712354219179762303)
,p_plug_template_id=>wwv_flow_imp.id(1127654121951791511)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712354736948762303)
,p_plug_template_id=>wwv_flow_imp.id(1127654121951791511)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712355266337762304)
,p_plug_template_id=>wwv_flow_imp.id(1127654121951791511)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712355789913762304)
,p_plug_template_id=>wwv_flow_imp.id(1127654121951791511)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712356287751762304)
,p_plug_template_id=>wwv_flow_imp.id(1127654121951791511)
,p_name=>'Sub Regions'
