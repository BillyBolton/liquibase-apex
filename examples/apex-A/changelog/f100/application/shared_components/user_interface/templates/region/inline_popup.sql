...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(138613530173338744)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712411123394762352)
,p_plug_template_id=>wwv_flow_imp.id(138613530173338744)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712411694263762352)
,p_plug_template_id=>wwv_flow_imp.id(138613530173338744)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712412166425762352)
,p_plug_template_id=>wwv_flow_imp.id(138613530173338744)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712412661944762353)
,p_plug_template_id=>wwv_flow_imp.id(138613530173338744)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712413127726762353)
,p_plug_template_id=>wwv_flow_imp.id(138613530173338744)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712413659905762353)
,p_plug_template_id=>wwv_flow_imp.id(138613530173338744)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712414134820762354)
,p_plug_template_id=>wwv_flow_imp.id(138613530173338744)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712414666399762354)
,p_plug_template_id=>wwv_flow_imp.id(138613530173338744)
,p_name=>'Sub Regions'
