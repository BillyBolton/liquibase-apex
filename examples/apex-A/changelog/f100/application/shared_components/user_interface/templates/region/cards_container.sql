...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(706313691095869162)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712296486308762252)
,p_plug_template_id=>wwv_flow_imp.id(706313691095869162)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712296976795762252)
,p_plug_template_id=>wwv_flow_imp.id(706313691095869162)
,p_name=>'Sort Order'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712297445372762252)
,p_plug_template_id=>wwv_flow_imp.id(706313691095869162)
,p_name=>'Sub Regions'
