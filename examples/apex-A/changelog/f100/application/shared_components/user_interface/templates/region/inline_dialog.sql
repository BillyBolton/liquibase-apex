...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1704192431604062592)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712387556713762332)
,p_plug_template_id=>wwv_flow_imp.id(1704192431604062592)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712388047515762332)
,p_plug_template_id=>wwv_flow_imp.id(1704192431604062592)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712388586845762333)
,p_plug_template_id=>wwv_flow_imp.id(1704192431604062592)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712389072063762333)
,p_plug_template_id=>wwv_flow_imp.id(1704192431604062592)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712389555536762333)
,p_plug_template_id=>wwv_flow_imp.id(1704192431604062592)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712390109014762334)
,p_plug_template_id=>wwv_flow_imp.id(1704192431604062592)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712390551684762334)
,p_plug_template_id=>wwv_flow_imp.id(1704192431604062592)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712391034613762334)
,p_plug_template_id=>wwv_flow_imp.id(1704192431604062592)
,p_name=>'Sub Regions'
