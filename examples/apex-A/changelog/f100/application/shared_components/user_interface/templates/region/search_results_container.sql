...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(416776046468628565)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712441250678762377)
,p_plug_template_id=>wwv_flow_imp.id(416776046468628565)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712441721897762378)
,p_plug_template_id=>wwv_flow_imp.id(416776046468628565)
,p_name=>'Search Field'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712442245383762378)
,p_plug_template_id=>wwv_flow_imp.id(416776046468628565)
,p_name=>'Sub Regions'
