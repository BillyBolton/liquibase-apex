...
wwv_flow_imp_shared.create_plug_template(
 p_id=>wwv_flow_imp.id(1704196012084062597)
,p_layout=>'TABLE'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712485167133762415)
,p_plug_template_id=>wwv_flow_imp.id(1704196012084062597)
,p_name=>'Region Body'
,p_placeholder=>'BODY'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712485640944762416)
,p_plug_template_id=>wwv_flow_imp.id(1704196012084062597)
,p_name=>'Change'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712486157932762416)
,p_plug_template_id=>wwv_flow_imp.id(1704196012084062597)
,p_name=>'Close'
,p_placeholder=>'CLOSE'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712486655642762416)
,p_plug_template_id=>wwv_flow_imp.id(1704196012084062597)
,p_name=>'Copy'
,p_placeholder=>'COPY'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712487147653762417)
,p_plug_template_id=>wwv_flow_imp.id(1704196012084062597)
,p_name=>'Create'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712487625960762417)
,p_plug_template_id=>wwv_flow_imp.id(1704196012084062597)
,p_name=>'Delete'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712488170976762417)
,p_plug_template_id=>wwv_flow_imp.id(1704196012084062597)
,p_name=>'Edit'
,p_placeholder=>'EDIT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712488644270762417)
,p_plug_template_id=>wwv_flow_imp.id(1704196012084062597)
,p_name=>'Help'
,p_placeholder=>'HELP'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712489129317762418)
,p_plug_template_id=>wwv_flow_imp.id(1704196012084062597)
,p_name=>'Next'
,p_placeholder=>'NEXT'
,p_has_grid_support=>false
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712489685952762418)
,p_plug_template_id=>wwv_flow_imp.id(1704196012084062597)
,p_name=>'Previous'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712490151633762418)
,p_plug_template_id=>wwv_flow_imp.id(1704196012084062597)
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712490627312762419)
,p_plug_template_id=>wwv_flow_imp.id(1704196012084062597)
,p_name=>'Sub Regions'
...
wwv_flow_imp_shared.create_plug_tmpl_display_point(
 p_id=>wwv_flow_imp.id(712491121682762419)
,p_plug_template_id=>wwv_flow_imp.id(1704196012084062597)
,p_name=>'Up'
,p_placeholder=>'UP'
,p_has_grid_support=>false
