...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(1463870166042090596)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(169692620830213727)
,p_plugin_id=>wwv_flow_imp.id(1463870166042090596)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(169693034271213727)
,p_plugin_id=>wwv_flow_imp.id(1463870166042090596)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_std_attribute(
 p_id=>wwv_flow_imp.id(169694317866213728)
,p_plugin_id=>wwv_flow_imp.id(1463870166042090596)
,p_name=>'SOURCE_SQL'
...
wwv_flow_imp_shared.create_plugin_file(
 p_id=>wwv_flow_imp.id(169695089102213731)
,p_plugin_id=>wwv_flow_imp.id(1463870166042090596)
