...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(1327292274727919802)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(615910145026655273)
,p_plugin_id=>wwv_flow_imp.id(1327292274727919802)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(615910567896655274)
,p_plugin_id=>wwv_flow_imp.id(1327292274727919802)
,p_attribute_scope=>'COMPONENT'
