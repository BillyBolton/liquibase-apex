...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(416952002025628712)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2859822382678869706)
,p_plugin_id=>wwv_flow_imp.id(416952002025628712)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2859821827666869705)
,p_plugin_id=>wwv_flow_imp.id(416952002025628712)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712739993541762757)
,p_plugin_id=>wwv_flow_imp.id(416952002025628712)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712740488676762758)
,p_plugin_id=>wwv_flow_imp.id(416952002025628712)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712740962210762759)
,p_plugin_id=>wwv_flow_imp.id(416952002025628712)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712741434183762760)
,p_plugin_id=>wwv_flow_imp.id(416952002025628712)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712742014653762761)
,p_plugin_id=>wwv_flow_imp.id(416952002025628712)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712742467136762761)
,p_plugin_id=>wwv_flow_imp.id(416952002025628712)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712742975783762762)
,p_plugin_id=>wwv_flow_imp.id(416952002025628712)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(712742014653762761)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2859822382678869706)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712743513188762762)
,p_plugin_attribute_id=>wwv_flow_imp.id(712742975783762762)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712744034729762763)
,p_plugin_attribute_id=>wwv_flow_imp.id(712742975783762762)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712744667558762764)
,p_plugin_attribute_id=>wwv_flow_imp.id(712742975783762762)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712745310691762765)
,p_plugin_id=>wwv_flow_imp.id(416952002025628712)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(712742975783762762)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712745739064762766)
,p_plugin_id=>wwv_flow_imp.id(416952002025628712)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712746303913762767)
,p_plugin_id=>wwv_flow_imp.id(416952002025628712)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712746759928762768)
,p_plugin_id=>wwv_flow_imp.id(416952002025628712)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712747248295762768)
,p_plugin_id=>wwv_flow_imp.id(416952002025628712)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712747719147762769)
,p_plugin_attribute_id=>wwv_flow_imp.id(712747248295762768)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712748354176762769)
,p_plugin_attribute_id=>wwv_flow_imp.id(712747248295762768)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712749014566762770)
,p_plugin_attribute_id=>wwv_flow_imp.id(712747248295762768)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712749517362762771)
,p_plugin_attribute_id=>wwv_flow_imp.id(712747248295762768)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712750157653762771)
,p_plugin_id=>wwv_flow_imp.id(416952002025628712)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(712742467136762761)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(2859821827666869705)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712750673046762772)
,p_plugin_id=>wwv_flow_imp.id(416952002025628712)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712751127216762773)
,p_plugin_id=>wwv_flow_imp.id(416952002025628712)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712751710676762773)
,p_plugin_id=>wwv_flow_imp.id(416952002025628712)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712752153226762774)
,p_plugin_id=>wwv_flow_imp.id(416952002025628712)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712752712640762775)
,p_plugin_id=>wwv_flow_imp.id(416952002025628712)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712753152091762775)
,p_plugin_attribute_id=>wwv_flow_imp.id(712752712640762775)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712753742283762776)
,p_plugin_attribute_id=>wwv_flow_imp.id(712752712640762775)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712754327228762777)
,p_plugin_id=>wwv_flow_imp.id(416952002025628712)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712754898580762778)
,p_plugin_attribute_id=>wwv_flow_imp.id(712754327228762777)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712755477391762779)
,p_plugin_attribute_id=>wwv_flow_imp.id(712754327228762777)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712756038859762780)
,p_plugin_attribute_id=>wwv_flow_imp.id(712754327228762777)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712756676507762780)
,p_plugin_id=>wwv_flow_imp.id(416952002025628712)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712757149013762781)
,p_plugin_attribute_id=>wwv_flow_imp.id(712756676507762780)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-Timeline--compact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712757789042762782)
,p_plugin_id=>wwv_flow_imp.id(416952002025628712)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2211805022208944250)
,p_plugin_id=>wwv_flow_imp.id(416952002025628712)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2326216385197207851)
,p_plugin_id=>wwv_flow_imp.id(416952002025628712)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2445247632171512292)
,p_plugin_id=>wwv_flow_imp.id(416952002025628712)
,p_name=>'Avatar Link'
