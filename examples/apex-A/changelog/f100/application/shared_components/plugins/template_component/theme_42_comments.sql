...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(416930693629628696)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2512536486775794312)
,p_plugin_id=>wwv_flow_imp.id(416930693629628696)
,p_title=>'Avatar'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712651675372762598)
,p_plugin_id=>wwv_flow_imp.id(416930693629628696)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712652171458762599)
,p_plugin_id=>wwv_flow_imp.id(416930693629628696)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712652686934762599)
,p_plugin_id=>wwv_flow_imp.id(416930693629628696)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712653192131762600)
,p_plugin_id=>wwv_flow_imp.id(416930693629628696)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712653653458762601)
,p_plugin_id=>wwv_flow_imp.id(416930693629628696)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(712660832361762610)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2512536486775794312)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712654186554762601)
,p_plugin_attribute_id=>wwv_flow_imp.id(712653653458762601)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712654768121762602)
,p_plugin_attribute_id=>wwv_flow_imp.id(712653653458762601)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712655385581762603)
,p_plugin_attribute_id=>wwv_flow_imp.id(712653653458762601)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712655959048762605)
,p_plugin_id=>wwv_flow_imp.id(416930693629628696)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(712653653458762601)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712656450488762606)
,p_plugin_id=>wwv_flow_imp.id(416930693629628696)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712656973534762606)
,p_plugin_id=>wwv_flow_imp.id(416930693629628696)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712657478141762607)
,p_plugin_id=>wwv_flow_imp.id(416930693629628696)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712657925744762607)
,p_plugin_id=>wwv_flow_imp.id(416930693629628696)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712658435720762608)
,p_plugin_attribute_id=>wwv_flow_imp.id(712657925744762607)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712659105899762608)
,p_plugin_attribute_id=>wwv_flow_imp.id(712657925744762607)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712659691577762609)
,p_plugin_attribute_id=>wwv_flow_imp.id(712657925744762607)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712660235459762609)
,p_plugin_attribute_id=>wwv_flow_imp.id(712657925744762607)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712660832361762610)
,p_plugin_id=>wwv_flow_imp.id(416930693629628696)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712661401517762611)
,p_plugin_id=>wwv_flow_imp.id(416930693629628696)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712661906630762611)
,p_plugin_id=>wwv_flow_imp.id(416930693629628696)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712662330854762612)
,p_plugin_attribute_id=>wwv_flow_imp.id(712661906630762611)
,p_display_sequence=>10
,p_display_value=>'Basic'
,p_return_value=>'t-Comments--basic'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712663012998762613)
,p_plugin_attribute_id=>wwv_flow_imp.id(712661906630762611)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712663588186762613)
,p_plugin_id=>wwv_flow_imp.id(416930693629628696)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(2216949049045761915)
,p_plugin_id=>wwv_flow_imp.id(416930693629628696)
,p_name=>'Link'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2216948457540754458)
,p_plugin_id=>wwv_flow_imp.id(416930693629628696)
,p_name=>'Actions'
,p_static_id=>'ACTIONS'
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2217004081210736337)
,p_plugin_id=>wwv_flow_imp.id(416930693629628696)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2217156298923607108)
,p_plugin_id=>wwv_flow_imp.id(416930693629628696)
