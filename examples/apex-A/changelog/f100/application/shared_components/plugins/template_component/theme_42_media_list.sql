...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(417015147292628757)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2512730156269646359)
,p_plugin_id=>wwv_flow_imp.id(417015147292628757)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2512729601257646358)
,p_plugin_id=>wwv_flow_imp.id(417015147292628757)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712712863326762713)
,p_plugin_id=>wwv_flow_imp.id(417015147292628757)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712713329364762713)
,p_plugin_id=>wwv_flow_imp.id(417015147292628757)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712713851165762714)
,p_plugin_id=>wwv_flow_imp.id(417015147292628757)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712714349175762715)
,p_plugin_id=>wwv_flow_imp.id(417015147292628757)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712714847856762716)
,p_plugin_id=>wwv_flow_imp.id(417015147292628757)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(712713851165762714)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2512730156269646359)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712715392364762717)
,p_plugin_attribute_id=>wwv_flow_imp.id(712714847856762716)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712716005140762718)
,p_plugin_attribute_id=>wwv_flow_imp.id(712714847856762716)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712716566295762718)
,p_plugin_attribute_id=>wwv_flow_imp.id(712714847856762716)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712717210876762719)
,p_plugin_id=>wwv_flow_imp.id(417015147292628757)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(712714847856762716)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712717666256762720)
,p_plugin_id=>wwv_flow_imp.id(417015147292628757)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712718194598762720)
,p_plugin_id=>wwv_flow_imp.id(417015147292628757)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712718668274762721)
,p_plugin_id=>wwv_flow_imp.id(417015147292628757)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712719138059762721)
,p_plugin_id=>wwv_flow_imp.id(417015147292628757)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712719636323762722)
,p_plugin_attribute_id=>wwv_flow_imp.id(712719138059762721)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712720257244762723)
,p_plugin_attribute_id=>wwv_flow_imp.id(712719138059762721)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712720901264762724)
,p_plugin_attribute_id=>wwv_flow_imp.id(712719138059762721)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712721430365762724)
,p_plugin_attribute_id=>wwv_flow_imp.id(712719138059762721)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712722089270762726)
,p_plugin_id=>wwv_flow_imp.id(417015147292628757)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(712714349175762715)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(2512729601257646358)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712722538352762726)
,p_plugin_id=>wwv_flow_imp.id(417015147292628757)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712723051702762727)
,p_plugin_id=>wwv_flow_imp.id(417015147292628757)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712723554740762728)
,p_plugin_id=>wwv_flow_imp.id(417015147292628757)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712724030165762729)
,p_plugin_id=>wwv_flow_imp.id(417015147292628757)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712724518854762730)
,p_plugin_id=>wwv_flow_imp.id(417015147292628757)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712725055882762731)
,p_plugin_attribute_id=>wwv_flow_imp.id(712724518854762730)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712725715359762732)
,p_plugin_attribute_id=>wwv_flow_imp.id(712724518854762730)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712726235260762733)
,p_plugin_id=>wwv_flow_imp.id(417015147292628757)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712726747091762733)
,p_plugin_attribute_id=>wwv_flow_imp.id(712726235260762733)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712727387710762734)
,p_plugin_attribute_id=>wwv_flow_imp.id(712726235260762733)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712727940982762735)
,p_plugin_attribute_id=>wwv_flow_imp.id(712726235260762733)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712728545225762735)
,p_plugin_id=>wwv_flow_imp.id(417015147292628757)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712729091699762736)
,p_plugin_attribute_id=>wwv_flow_imp.id(712728545225762735)
,p_display_sequence=>10
,p_display_value=>'2 Column Grid'
,p_return_value=>'t-MediaList--cols t-MediaList--2cols'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712729682372762736)
,p_plugin_attribute_id=>wwv_flow_imp.id(712728545225762735)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712730287736762737)
,p_plugin_attribute_id=>wwv_flow_imp.id(712728545225762735)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712730904418762737)
,p_plugin_attribute_id=>wwv_flow_imp.id(712728545225762735)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712731430400762739)
,p_plugin_attribute_id=>wwv_flow_imp.id(712728545225762735)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712732079346762739)
,p_plugin_id=>wwv_flow_imp.id(417015147292628757)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712732599025762740)
,p_plugin_attribute_id=>wwv_flow_imp.id(712732079346762739)
,p_display_sequence=>10
,p_display_value=>'Large'
,p_return_value=>'t-MediaList--large force-fa-lg'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712733173003762741)
,p_plugin_id=>wwv_flow_imp.id(417015147292628757)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2217236817196659034)
,p_plugin_id=>wwv_flow_imp.id(417015147292628757)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
