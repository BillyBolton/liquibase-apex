...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(416907057861628678)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712622891682762550)
,p_plugin_id=>wwv_flow_imp.id(416907057861628678)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712623367424762551)
,p_plugin_attribute_id=>wwv_flow_imp.id(712622891682762550)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'IMAGE'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712623940962762552)
,p_plugin_attribute_id=>wwv_flow_imp.id(712622891682762550)
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712624595219762552)
,p_plugin_attribute_id=>wwv_flow_imp.id(712622891682762550)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712625183568762553)
,p_plugin_id=>wwv_flow_imp.id(416907057861628678)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(712622891682762550)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712625617282762554)
,p_plugin_id=>wwv_flow_imp.id(416907057861628678)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712626171255762555)
,p_plugin_id=>wwv_flow_imp.id(416907057861628678)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712626673682762555)
,p_plugin_id=>wwv_flow_imp.id(416907057861628678)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712627194457762556)
,p_plugin_id=>wwv_flow_imp.id(416907057861628678)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712627623959762556)
,p_plugin_attribute_id=>wwv_flow_imp.id(712627194457762556)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712628279825762557)
,p_plugin_attribute_id=>wwv_flow_imp.id(712627194457762556)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712628828647762558)
,p_plugin_attribute_id=>wwv_flow_imp.id(712627194457762556)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712629419617762559)
,p_plugin_attribute_id=>wwv_flow_imp.id(712627194457762556)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712630027214762559)
,p_plugin_id=>wwv_flow_imp.id(416907057861628678)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712630539022762560)
,p_plugin_attribute_id=>wwv_flow_imp.id(712630027214762559)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712631190871762561)
,p_plugin_attribute_id=>wwv_flow_imp.id(712630027214762559)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712631766349762561)
,p_plugin_attribute_id=>wwv_flow_imp.id(712630027214762559)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712632391465762562)
,p_plugin_attribute_id=>wwv_flow_imp.id(712630027214762559)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712632997094762563)
,p_plugin_attribute_id=>wwv_flow_imp.id(712630027214762559)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712633580872762563)
,p_plugin_attribute_id=>wwv_flow_imp.id(712630027214762559)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712634165746762564)
,p_plugin_attribute_id=>wwv_flow_imp.id(712630027214762559)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712634793727762565)
,p_plugin_id=>wwv_flow_imp.id(416907057861628678)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2216958112502742431)
,p_plugin_id=>wwv_flow_imp.id(416907057861628678)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
