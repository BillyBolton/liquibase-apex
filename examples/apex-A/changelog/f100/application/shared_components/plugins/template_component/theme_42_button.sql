...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(416947497376628708)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712646856745762586)
,p_plugin_id=>wwv_flow_imp.id(416947497376628708)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712647359578762587)
,p_plugin_id=>wwv_flow_imp.id(416947497376628708)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712647910012762588)
,p_plugin_id=>wwv_flow_imp.id(416947497376628708)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712648318155762589)
,p_plugin_id=>wwv_flow_imp.id(416947497376628708)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712648902725762589)
,p_plugin_id=>wwv_flow_imp.id(416947497376628708)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712649363730762590)
,p_plugin_id=>wwv_flow_imp.id(416947497376628708)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712649890427762591)
,p_plugin_id=>wwv_flow_imp.id(416947497376628708)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712650400111762591)
,p_plugin_id=>wwv_flow_imp.id(416947497376628708)
,p_attribute_scope=>'COMPONENT'
