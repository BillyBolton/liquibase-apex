...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(416977975033628731)
...
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2383012934860560811)
,p_plugin_id=>wwv_flow_imp.id(416977975033628731)
,p_title=>'Appearance'
,p_display_sequence=>30
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2639905553602834325)
,p_plugin_id=>wwv_flow_imp.id(416977975033628731)
,p_title=>'Avatar'
,p_display_sequence=>10
);
wwv_flow_imp_shared.create_plugin_attr_group(
 p_id=>wwv_flow_imp.id(2639904998590834324)
,p_plugin_id=>wwv_flow_imp.id(416977975033628731)
,p_title=>'Badge'
,p_display_sequence=>20
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712669313074762635)
,p_plugin_id=>wwv_flow_imp.id(416977975033628731)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712669785809762636)
,p_plugin_id=>wwv_flow_imp.id(416977975033628731)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712670247489762637)
,p_plugin_id=>wwv_flow_imp.id(416977975033628731)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712670751811762638)
,p_plugin_id=>wwv_flow_imp.id(416977975033628731)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712671231830762639)
,p_plugin_id=>wwv_flow_imp.id(416977975033628731)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712671725824762639)
,p_plugin_id=>wwv_flow_imp.id(416977975033628731)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712672282456762640)
,p_plugin_id=>wwv_flow_imp.id(416977975033628731)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(712671231830762639)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_lov_type=>'STATIC'
,p_attribute_group_id=>wwv_flow_imp.id(2639905553602834325)
,p_help_text=>'Select the type of content that will be displayed in the avatar.'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712672738803762640)
,p_plugin_attribute_id=>wwv_flow_imp.id(712672282456762640)
,p_display_sequence=>10
,p_display_value=>'Image'
,p_return_value=>'image'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712673399817762641)
,p_plugin_attribute_id=>wwv_flow_imp.id(712672282456762640)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712673918078762642)
,p_plugin_attribute_id=>wwv_flow_imp.id(712672282456762640)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712674519544762643)
,p_plugin_id=>wwv_flow_imp.id(416977975033628731)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_depending_on_attribute_id=>wwv_flow_imp.id(712672282456762640)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712675100657762644)
,p_plugin_id=>wwv_flow_imp.id(416977975033628731)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712675581078762645)
,p_plugin_id=>wwv_flow_imp.id(416977975033628731)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712676060985762646)
,p_plugin_id=>wwv_flow_imp.id(416977975033628731)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712676570884762647)
,p_plugin_id=>wwv_flow_imp.id(416977975033628731)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712676994782762647)
,p_plugin_attribute_id=>wwv_flow_imp.id(712676570884762647)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712677557727762648)
,p_plugin_attribute_id=>wwv_flow_imp.id(712676570884762647)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712678186526762648)
,p_plugin_attribute_id=>wwv_flow_imp.id(712676570884762647)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712678798282762649)
,p_plugin_attribute_id=>wwv_flow_imp.id(712676570884762647)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712679413174762651)
,p_plugin_id=>wwv_flow_imp.id(416977975033628731)
,p_attribute_scope=>'COMPONENT'
...
,p_escape_mode=>'HTML'
,p_is_translatable=>true
,p_depending_on_attribute_id=>wwv_flow_imp.id(712671725824762639)
,p_depending_on_has_to_exist=>true
,p_depending_on_condition_type=>'EQUALS'
,p_depending_on_expression=>'Y'
,p_attribute_group_id=>wwv_flow_imp.id(2639904998590834324)
,p_help_text=>'Enter a value for the badge label or select a source column from the quick pick options.'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712679888716762652)
,p_plugin_id=>wwv_flow_imp.id(416977975033628731)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712680391081762653)
,p_plugin_id=>wwv_flow_imp.id(416977975033628731)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712680855491762653)
,p_plugin_id=>wwv_flow_imp.id(416977975033628731)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712681322987762654)
,p_plugin_id=>wwv_flow_imp.id(416977975033628731)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712681905167762654)
,p_plugin_id=>wwv_flow_imp.id(416977975033628731)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712682405722762655)
,p_plugin_attribute_id=>wwv_flow_imp.id(712681905167762654)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712682972395762656)
,p_plugin_attribute_id=>wwv_flow_imp.id(712681905167762654)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712683532563762656)
,p_plugin_id=>wwv_flow_imp.id(416977975033628731)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712684069847762657)
,p_plugin_attribute_id=>wwv_flow_imp.id(712683532563762656)
,p_display_sequence=>10
,p_display_value=>'Rounded'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712684670161762658)
,p_plugin_attribute_id=>wwv_flow_imp.id(712683532563762656)
,p_display_sequence=>20
,p_display_value=>'Circular'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712685284080762658)
,p_plugin_attribute_id=>wwv_flow_imp.id(712683532563762656)
,p_display_sequence=>30
,p_display_value=>'Square'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712685858847762660)
,p_plugin_attribute_id=>wwv_flow_imp.id(712683532563762656)
,p_display_sequence=>40
,p_display_value=>'No Shape'
,p_return_value=>'t-Avatar--noShape'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712686445319762661)
,p_plugin_id=>wwv_flow_imp.id(416977975033628731)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712687014282762662)
,p_plugin_attribute_id=>wwv_flow_imp.id(712686445319762661)
,p_display_sequence=>10
,p_display_value=>'Extra Extra Small'
,p_return_value=>'t-Avatar--xxs'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712687523045762662)
,p_plugin_attribute_id=>wwv_flow_imp.id(712686445319762661)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712688175815762663)
,p_plugin_attribute_id=>wwv_flow_imp.id(712686445319762661)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712688815314762665)
,p_plugin_attribute_id=>wwv_flow_imp.id(712686445319762661)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712689338483762665)
,p_plugin_attribute_id=>wwv_flow_imp.id(712686445319762661)
,p_display_sequence=>50
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712689916734762666)
,p_plugin_attribute_id=>wwv_flow_imp.id(712686445319762661)
,p_display_sequence=>60
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712690589892762667)
,p_plugin_attribute_id=>wwv_flow_imp.id(712686445319762661)
,p_display_sequence=>70
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712691155319762668)
,p_plugin_id=>wwv_flow_imp.id(416977975033628731)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712691706033762669)
,p_plugin_attribute_id=>wwv_flow_imp.id(712691155319762668)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712692279639762670)
,p_plugin_attribute_id=>wwv_flow_imp.id(712691155319762668)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712692883035762671)
,p_plugin_attribute_id=>wwv_flow_imp.id(712691155319762668)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712693455314762674)
,p_plugin_id=>wwv_flow_imp.id(416977975033628731)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712693925006762675)
,p_plugin_attribute_id=>wwv_flow_imp.id(712693455314762674)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-ContentRow-badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712694521760762676)
,p_plugin_attribute_id=>wwv_flow_imp.id(712693455314762674)
,p_display_sequence=>20
,p_display_value=>'Medium'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712695163882762677)
,p_plugin_attribute_id=>wwv_flow_imp.id(712693455314762674)
,p_display_sequence=>30
,p_display_value=>'Large'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712695716882762678)
,p_plugin_attribute_id=>wwv_flow_imp.id(712693455314762674)
,p_display_sequence=>40
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712696343236762679)
,p_plugin_id=>wwv_flow_imp.id(416977975033628731)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712696898752762680)
,p_plugin_attribute_id=>wwv_flow_imp.id(712696343236762679)
,p_display_sequence=>10
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712697491633762681)
,p_plugin_id=>wwv_flow_imp.id(416977975033628731)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712698517789762683)
,p_plugin_attribute_id=>wwv_flow_imp.id(712697491633762681)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712698007617762682)
,p_plugin_attribute_id=>wwv_flow_imp.id(712697491633762681)
,p_display_sequence=>20
,p_display_value=>'End'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712699137442762684)
,p_plugin_id=>wwv_flow_imp.id(416977975033628731)
...
,p_escape_mode=>'ATTR'
,p_is_translatable=>false
,p_attribute_group_id=>wwv_flow_imp.id(2383012934860560811)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712699681964762685)
,p_plugin_id=>wwv_flow_imp.id(416977975033628731)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712700451458762687)
,p_plugin_attribute_id=>wwv_flow_imp.id(712699681964762685)
,p_display_sequence=>10
,p_display_value=>'Compact'
,p_return_value=>'t-ContentRow--styleCompact'
);
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712701064893762687)
,p_plugin_id=>wwv_flow_imp.id(416977975033628731)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712701533893762688)
,p_plugin_id=>wwv_flow_imp.id(416977975033628731)
,p_attribute_scope=>'REPORT'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(2225429871475522040)
,p_plugin_id=>wwv_flow_imp.id(416977975033628731)
,p_name=>'Button'
,p_type=>'BUTTON'
...
wwv_flow_imp_shared.create_plugin_act_template(
 p_id=>wwv_flow_imp.id(2225431130995526188)
,p_plugin_id=>wwv_flow_imp.id(416977975033628731)
,p_name=>'Menu'
,p_type=>'MENU'
,p_template=>wwv_flow_string.join(wwv_flow_t_varchar2(
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2211836242801115307)
,p_plugin_id=>wwv_flow_imp.id(416977975033628731)
,p_name=>'Title Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2212515543531198411)
,p_plugin_id=>wwv_flow_imp.id(416977975033628731)
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2224167928922897509)
,p_plugin_id=>wwv_flow_imp.id(416977975033628731)
,p_name=>'Badge Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2225427936408477054)
,p_plugin_id=>wwv_flow_imp.id(416977975033628731)
,p_name=>'Avatar Link'
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2225429269798490911)
,p_plugin_id=>wwv_flow_imp.id(416977975033628731)
