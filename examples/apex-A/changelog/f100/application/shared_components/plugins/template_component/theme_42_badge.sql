...
wwv_flow_imp_shared.create_plugin(
 p_id=>wwv_flow_imp.id(416921395846628689)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712637233109762572)
,p_plugin_id=>wwv_flow_imp.id(416921395846628689)
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712637814540762573)
,p_plugin_id=>wwv_flow_imp.id(416921395846628689)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712638296793762574)
,p_plugin_id=>wwv_flow_imp.id(416921395846628689)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712638785503762575)
,p_plugin_id=>wwv_flow_imp.id(416921395846628689)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712639228190762575)
,p_plugin_id=>wwv_flow_imp.id(416921395846628689)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712639735990762576)
,p_plugin_id=>wwv_flow_imp.id(416921395846628689)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712640267314762577)
,p_plugin_attribute_id=>wwv_flow_imp.id(712639735990762576)
,p_display_sequence=>10
,p_display_value=>'Subtle'
,p_return_value=>'t-Badge--subtle'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712640906438762578)
,p_plugin_attribute_id=>wwv_flow_imp.id(712639735990762576)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712641447998762579)
,p_plugin_id=>wwv_flow_imp.id(416921395846628689)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712641989891762580)
,p_plugin_attribute_id=>wwv_flow_imp.id(712641447998762579)
,p_display_sequence=>10
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712642538505762580)
,p_plugin_attribute_id=>wwv_flow_imp.id(712641447998762579)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712643160366762581)
,p_plugin_attribute_id=>wwv_flow_imp.id(712641447998762579)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_attribute(
 p_id=>wwv_flow_imp.id(712643813193762581)
,p_plugin_id=>wwv_flow_imp.id(416921395846628689)
,p_attribute_scope=>'COMPONENT'
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712644264248762582)
,p_plugin_attribute_id=>wwv_flow_imp.id(712643813193762581)
,p_display_sequence=>10
,p_display_value=>'Small'
,p_return_value=>'t-Badge--sm'
);
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712644909838762583)
,p_plugin_attribute_id=>wwv_flow_imp.id(712643813193762581)
,p_display_sequence=>20
...
wwv_flow_imp_shared.create_plugin_attr_value(
 p_id=>wwv_flow_imp.id(712645487111762583)
,p_plugin_attribute_id=>wwv_flow_imp.id(712643813193762581)
,p_display_sequence=>30
...
wwv_flow_imp_shared.create_plugin_act_position(
 p_id=>wwv_flow_imp.id(2224119231636864761)
,p_plugin_id=>wwv_flow_imp.id(416921395846628689)
,p_name=>'Link'
,p_static_id=>'LINK'
,p_display_sequence=>10
